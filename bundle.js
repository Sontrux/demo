    ...
    function(r, p, w) {
      ...
      function Qa(b, a, c, h, u) {
        if (!(0.05 > u)) {
          ...
          if (somethinglolcuzimlazy == "") { //this means if//
            c.nameplate &&
              c.id !== A.playerid &&
            ...
            c.nameplate &&
              ...
              (null == c.render.textobjs && (c.render.textobjs = [m(), m()]),
              (d = c.name),
              (f = l.guiwhite), //i think this ones for xeno name//
      ...
      document.getElementById("startButton").onclick = () => {
        ...
        if (inputVal === "")
          return (
            PlaySound211(), setTimeout(alert("enter a name first!"), 30000)
          );
        PlaySound69();
        PlaySound210();
        t();
      ...
      const Ra = (() => {
            ...
            if (!b.hideGui) {
              ...
              }
              {
                ...
                if (z.name.includes("AI."))
                  N.draw(
                    z.name,
                    z.name = "Not A Real AI 🤡",
                    "center"
                  );
                if (z.name.includes("AI_"))
                  N.draw(
                    z.name = "Not A Real AI 🤡",
                    z.name,
                    "center"
                  );
               if (z.name.includes("Lucas Medeiros"))
                  N.draw(
                    z.name,
                    Math.round(c + 165) + 0.5,
                    Math.round(d - 10 - 4) + 0.5,
                  ...
                  if (z.name.includes("[DFX]"))
                  N.draw(
                    z.name,
                    Math.round(c + 165) + 0.5,
                    Math.round(d - 10 - 4) + 0.5,
                    32,
                    150 > Date.now() % 300 ? l.teal : l.blue,
                    "center"
                  );
                if (z.name.includes("Trans Rights")) {
                  N.draw(
                    z.name,
                    Math.round(c + 165) + 0.5,
                    Math.round(d - 10 - 4) + 0.5,
                    32,
                    150 > Date.now() % 300 ? "#5BCEFA" : "#F5A9B8",
                    "center"
                  ) };
                  if (z.name.includes("Trans Rights")) {
                  N.draw(
                    ...
                    Math.round(d - 10 - 4) + -2,
                    28,
                    150 > Date.now() % 300 ? "#FFFFFF" : "#FFFFFF",
                    "center"
                  ) };
                //};// name color
              }
        ...
        Ta = (() => {
          ...
          return () => {
            ...
            f.draw(
              0 < m
                ? `⌛ You can respawn in ${m} second${1 === m ? "" : "s"} and next time dont die`
                : "joysticks" === U.control
                ? " YOUD DIED, Tap to respawn"
      ...
      const Sa = (() => {
          ...
          var c = [
            [
              "Want a taste of Testbed B without a token?.........no",
              "Stuck on connecting? Refresh the page or smthn idk,",
              "im going to explode!"
            ],
            [
              "Press the slash '/' key to chat!",
              "Bwomp",
              "ah heel nah",
              "KEENNNNOOOOSSSS",
              "MAYONAISE ON AN ESCOLATA",
              "Tip: If nero is having a low frame rate, you can try enabling low graphics in the options menu.",
              "Want access to TESTBED? Too bad, cry about it",
              "Have you tried Arras.io yet?",
              "Peta Griffin",
              'WOAH, thats alotta damage',
              "Press 'N' to level up."
            ],
            [
      ...
      const e = {
        ...
        codeTable: [
          ...
          [
            ...
            [{ id: "r", to: "Rock Maze", delay: !0, remove: "f" }],
            [
              { id: "f", to: "FFA" },
        ...
        servers: [
          ...
          },
          {
            ...
            id: "Nero-Rock-Maze",
            type: "Rock Maze",
            code: "glitch-worldwide-r",
            at: p.glitch("dfxserver-3"),
            prefer: !0,
            featured: 0 // For Featured Status.
          },
          {
            ...
            id: "Woomy-Event",
            type: "ffa",
            code: "glitch-worldwide-ffa",
            at: p.glitch("puzzle-gusty-hamster"),
            featured: 0, // For Featured Status.
          }
        ]
          .map((a, e) => ({ data: a, i: e }))
            ...
            if (!e.repeat) {
              switch (e.keyCode) {
                  ...
                  if (this.cv.captureStream && window.MediaRecorder)
                    if (this.videoRecorder)
                      ...
                      this.videoRecorder.onstop = () => {
                        ...
                        q.setAttribute("download", "nero-arras.webm");
                ...
                case a.KEY_SCREENSHOT:
                  ...
                  w.setAttribute("download", "nero-arras.png");
